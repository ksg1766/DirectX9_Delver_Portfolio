...
HRESULT CStage::Ready_Layer_GameLogic(LAYERTAG _eLayerTag)
{
	...
	//NULL_CHECK_RETURN(pGameObject, E_FAIL);
	//pGameObject->m_pTransform->Translate(_vec3(-45.f, 3.f, -45.f));
...
HRESULT CStage::Load_Data()
{
	...
	//HANDLE hFile = CreateFile(L"../Bin/Data/Swere.dat", GENERIC_READ, 0, 0, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, 0);
