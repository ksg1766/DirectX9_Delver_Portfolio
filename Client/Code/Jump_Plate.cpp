...
void CJump_Plate::OnCollisionStay(CCollider* _pOther)
{
	...
	{
		_vec3 JumpDir = m_pOtherObj->m_pTransform->m_vInfo[INFO_LOOK] * 5.f;//(static_cast<CPlayer*>(m_pOtherObj)->Get_Speed());
		(static_cast<CPlayer*>(_pOther->Get_Host())->Get_RigidBody()->Add_Force(_vec3(JumpDir.x, 1.1f * 15.f, JumpDir.z)));
