...
#pragma region Stage
	...
	case LOADINGID::LOADING_STAGE:
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_Bow", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Equip/Weapon/Bow%d.png", 4)), E_FAIL);
