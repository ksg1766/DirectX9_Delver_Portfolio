...
#pragma region UI
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_PoisonHpBarUI",			CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/HPbar/helthPoisonbar%d.png", 2)), E_FAIL);
