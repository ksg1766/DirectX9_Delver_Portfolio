...
#pragma region Stage
	...
	case LOADINGID::LOADING_STAGE:
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_KingSpider", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Entities/Cave/Spider/Move/Move%d.png", 4)), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_KingSpiderAttack", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Entities/Cave/Spider/Attack/Attack%d.png", 9)), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_KingSpiderHit", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Entities/Cave/Spider/Dead/Dead0.png")), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_KingSpiderDead", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Entities/Cave/Spider/Dead/Dead1.png")), E_FAIL);
...
#pragma region Cube
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_Tile", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Tile/Stage/tile%d.png", 55)), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_Cube", CTexture::Create(m_pGraphicDev, TEX_CUBE, L"../Bin/SRSource/Cube/Stage/cube%d.dds", 55)), E_FAIL);
...
#pragma region UI
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_PoisionHpBarUI",	  CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/HPbar/helthPoisonbar%d.png", 2)), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_itemUI",              CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/Inventory/item/itemUI%d.png", 44)), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_UIOrbLight",          CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/OrbClearLight/OrbClearLight%d.png", 15)), E_FAIL);

		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_UIWhite",             CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/WhiteOutIn/white%d.png", 38)), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_UITitle",			  CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/UITitle/UITitle%d.png", 9)), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_CreditUI", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/UI/Credit.png")), E_FAIL);
#pragma endregion UI
...
#pragma region Boss
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_BossPortal", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Entities/Boss/Portal/Portal%d.png",5)), E_FAIL);
...
#pragma region EFFECT
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_EffectSpiderFog", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Effect/Etc/Vfx0/Vfx0.png")), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_EffectFireWorkMain", CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Village/Effect_White.png", 1)), E_FAIL);
...
#pragma region SOUND
		// 테스트용
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/win.mp3", "win.mp3"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/en_skull_die_01.mp3", "en_skull_die_01"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/ShieldSwing.wav", "ShieldSwing.wav"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/AstalgiaofPhantam.mp3", "AstalgiaofPhantam"), E_FAIL);
		...
		// Collision && Break 
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/trap_spike.mp3", "trap_spike.mp3"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/mg_pass_poison.mp3", "mg_pass_poison.mp3"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/sfx_explode.mp3", "sfx_explode.mp3"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_Taunt2.wav", "Boss_Taunt3.wav"), E_FAIL);
		...
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Fire_Hit1.wav", "Fire_Hit1.wav"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_MeteorCharging.wav", "Boss_MeteorCharging.wav"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_Power1.wav", "Boss_Power1.wav"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_Power2.wav", "Boss_Power2.wav"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_Roar1.wav", "Boss_Roar1.wav"), E_FAIL);
		FAILED_CHECK_RETURN(CSoundManager::GetInstance()->LoadSound("../Bin/SRSource/Sound/Boss/Boss_Roar2.wav", "Boss_Roar2.wav"), E_FAIL);
...
#pragma region VILLAGE
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_VillageSkyBox", CTexture::Create(m_pGraphicDev, TEX_CUBE,   L"../Bin/SRSource/Village/Sky/VillageSky%d.dds", 2)), E_FAIL);
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_Moon",          CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Village/Sky/Moon%d.png", 2)), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_Star",          CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Village/Sky/Star%d.png", 3)), E_FAIL);
		...
		FAILED_CHECK_RETURN(Engine::PrototypeManager()->Ready_Proto(L"Proto_Texture_OrbBlockLight",   CTexture::Create(m_pGraphicDev, TEX_NORMAL, L"../Bin/SRSource/Village/OrbLight.png", 1)), E_FAIL);
