...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, TERRAIN, BLOCK, PLAYER, ITEM, ENVIRONMENT_OBJECT, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, NPC, EFFECT, OBJECT_END };
