...
namespace Engine
{
	...
	enum ITEMTYPE           { ITEMTYPE_WEAPONITEM, ITEMTYPE_GENERALITEM, ITEMTYPE_EQUIPITEM, ITEMTYPE_EATITEM, ITEMTYPE_POTIONITEM, ITEMTYPE_QUEST, ITEMTYPE_END};
	...
	enum ITEMID             { WEAPON_SWORD,                                    // 근접 무기 칼
		...
		WEAPON_EPICBOW, QUEST_PART1, QUSET_PART2, QUSET_PART3, QUSET_PART4, QUSET_PART5, QUSET_PART6,
