...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, TERRAIN, BLOCK, PLAYER, ITEM, IMMORTAL, MONSTER, BOSS, CAMERA, UI, ENVIRONMENTAL, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, FRAGILE, NPC, EFFECT, RAY, OBJECT_END };
