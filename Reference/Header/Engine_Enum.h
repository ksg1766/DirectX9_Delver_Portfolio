...
namespace Engine
{
	...
	enum EFFECTTAG          { EFFECT_BUBBLE, EFFECT_BROKENBOX, EFFECT_DAMAGE, EFFECT_DAMAGESTAR, EFFECT_BLOOD, EFFECT_WAND, EFFECT_EXPLOSION, EFFECT_EXPLOSIONCHILD, EFFECT_PROJECTILETRACE, EFFECT_TRACE, EFFECT_TWINKLE, EFFECT_PASTTRACE, EFFECT_STAR ,EFFECT_END };
