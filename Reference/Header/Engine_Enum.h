...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, PLAYER, BLOCK, ITEM, IMMORTAL, FRAGILE, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, NPC, EFFECT, TRAP, RAY, TRIGERBLOCK, OBJECT_END };
	...
	enum class STATE		{ IDLE, ROMIMG, ATTACK, HIT, DEAD, SEMI_PATTERN1, SEMI_PATTERN2,
								BOSS_SLEEP, BOSS_WAKEUP, BOSS_IDLE, BOSS_STURN, BOSS_ATTACK,
								...
								BOSS_METEORREADY,BOSS_CRAWL, BOSS_SPWANMONSTER, BOSS_DYING, BOSS_DEAD ,STATE_END };
	...
	enum class ENVIRONMENTTAG { TREE, ROCK, GRASS, ENVIRONMENT_END };
	...
	enum EFFECTTAG          { EFFECT_BUBBLE, EFFECT_BROKENBOX, EFFECT_DAMAGE, EFFECT_DAMAGESTAR, EFFECT_BLOOD, EFFECT_WAND, EFFECT_EXPLOSION, EFFECT_EXPLOSIONCHILD, EFFECT_PROJECTILETRACE, EFFECT_TRACE, EFFECT_TWINKLE, EFFECT_PASTTRACE, EFFECT_STAR , EFFECT_BONEFIRE, EFFECT_END };
	enum PARTICLETAG        { PARTICLE_SQUARE, PARTICLE_END };

	enum CHANNELID          { SOUND_EFFECT, SOUND_BGM, SOUND_WEAPON, SOUND_UI, SOUND_PLAYER, SOUND_MONSTER, SOUND_CONSUMABLE, SOUND_MAXCHANNEL };
};
