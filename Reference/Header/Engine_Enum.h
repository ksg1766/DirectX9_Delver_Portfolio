...
namespace Engine
{
	...
	enum class STATE { IDLE, ROMIMG, ATTACK, HIT, DEAD, 
		BOSS_SLEEP, BOSS_WAKEUP, BOSS_IDLE, BOSS_GROGGY, BOSS_ATTACK, BOSS_FIRE, BOSS_EXPLOSION, BOSS_TELEPORT
	...
	enum UIOBJECTTTAG       { UIID_SLOTBASIC, UIID_SLOTEMPTY, UIID_SLOTEQUIPMENT, UIID_INVENBUTTON, UIID_END };
}
