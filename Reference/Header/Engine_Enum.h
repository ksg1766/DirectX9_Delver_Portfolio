...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, TERRAIN, BLOCK, PLAYER, ITEM, FRAGILE, IMMORTAL, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, NPC, EFFECT, RAY, OBJECT_END };
	...
	enum EFFECTCOLOR        { ECOLOR_PINK ,ECOLOR_RED, ECOLOR_ORANGE, ECOLOR_YELLOW, ECOLOR_LIGHTGREEN, ECOLOR_GREEN, ECOLOR_SKYBLUE, ECOLOR_BLUE, ECOLOR_INDIGO, ECOLOR_PURPLE, ECOLOR_WHITE, ECOLOR_RAINBOW, ECOLOR_BROWN, ECOLOR_APRICOT, ECOLOR_END };
	enum EFFECTTAG          { EFFECT_BUBBLE, EFFECT_BROKENBOX, EFFECT_DAMAGE, EFFECT_DAMAGESTAR, EFFECT_BLOOD, EFFECT_WAND, EFFECT_EXPLOSION, EFFECT_EXPLOSIONCHILD, EFFECT_PROJECTILETRACE, EFFECT_TRACE, EFFECT_TWINKLE, EFFECT_END };
