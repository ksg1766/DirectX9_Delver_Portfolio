...
namespace Engine
{
	...
	enum CHANNELID          { SOUND_EFFECT, SOUND_BGM, SOUND_WEAPON, SOUND_UI, SOUND_PLAYER, SOUND_MONSTER, SOUND_CONSUMABLE, SOUND_INVENTORY, SOUND_ENVIRONMENT, SOUND_BREAK, SOUND_MAXCHANNEL };
};
