...
namespace Engine
{
	...
	enum class COMPONENTTAG {
		BUFFER, TEXTURE0, TEXTURE1, TRANSFORM, COLLIDER, RIGIDBODY, LIGHT, CAMERA, BASICSTAT, MONSTERAI,
		ANIMATOR, PARTICLE, BILLBOARD, STATEMACHINE, INVENTORY, FONT, COMPONENT_END
	};

	// STATE
	enum class STATE {
		IDLE, ROMIMG, ATTACK, HIT, DEAD, SEMI_PATTERN1, SEMI_PATTERN2,
