...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, PLAYER, BLOCK, ITEM, IMMORTAL, FRAGILE, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, NPC, EFFECT, TRAP, RAY, OBJECT_END };
