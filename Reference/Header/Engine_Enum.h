...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, TERRAIN, BLOCK, PLAYER, ITEM, ENVIRONMENT_OBJECT, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, NPC, EFFECT, SPAWNINGPOOL, OBJECT_END };
