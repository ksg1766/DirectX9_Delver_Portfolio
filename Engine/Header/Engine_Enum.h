...
namespace Engine
{
	...
	enum EFFECTCOLOR        { ECOLOR_PINK ,ECOLOR_RED, ECOLOR_ORANGE, ECOLOR_YELLOW, ECOLOR_LIGHTGREEN, ECOLOR_GREEN, ECOLOR_SKYBLUE, ECOLOR_BLUE, ECOLOR_INDIGO, ECOLOR_PURPLE, ECOLOR_END };
};
