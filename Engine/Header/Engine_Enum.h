...
namespace Engine
{
	...
	enum RENDERID			{ RENDER_PRIORITY, RENDER_NONALPHA, RENDER_ALPHA, RENDER_EFFECT, RENDER_ITEM, RENDER_UI, RENDER_END };

	enum MOUSEKEYSTATE		{ DIM_LB, DIM_RB, DIM_MB, DIM_END };
	enum MOUSEMOVESTATE		{ DIMS_X, DIMS_Y, DIMS_Z, DIMS_END };

	enum class CAMERA_TYPE	{ PERSPECTIVE, ORTHOGRAPHIC, MOVE_CAMERA, CAMERA_END};
	...
	enum class SCENETAG		{ LOGO, LOADING, VILLAGE, STAGE, BOSSSTAGE, CREDIT, EDITOR, SCENE_END};
	...
	enum class OBJECTTAG	{ BACKGROUND, PLAYER, BLOCK, ITEM, IMMORTAL, FRAGILE, MONSTER, BOSS, CAMERA, UI, SKYBOX, PLAYERBULLET, MONSTERBULLET, SPAWNINGPOOL, NPC, EFFECT, TRAP, RAY, TRIGERBLOCK, LOSTSOUL, DOORBLOCK, OBJECT_END };
	enum class BLOCKTAG		{ NORMAL_BLOCK, WATER_BLOCK, BLOCK_END };
	...
	enum UIPOPUPLAYER       { POPUP_BOSSHP, POPUP_MOUSE, POPUP_INVEN, POPUP_EQUIPMENT, POPUP_STAT, POPUP_ITEM, POPUP_MAP, POPUP_SPEECH, POPUP_SHOP, POPUP_LEVELUP, POPUP_ESC, POPUP_BLACK, POPUP_END };
	enum UIOBJECTTTAG       { UIID_BASIC, UIID_SLOTBASIC, UIID_SLOTEMPTY, UIID_SLOTEQUIPMENT, UIID_INVENBUTTON, UIID_PICTURE, UIID_END };
	...
	enum ITEMTYPE           { ITEMTYPE_WEAPONITEM, ITEMTYPE_GENERALITEM, ITEMTYPE_EQUIPITEM, ITEMTYPE_EATITEM, ITEMTYPE_POTIONITEM, ITEMTYPE_ORB, ITEMTYPE_QUEST, ITEMTYPE_END};
	...
	enum ITEMID             { WEAPON_SWORD,                                    // 근접 무기 칼
		...
		WEAPON_EPICBOW, QUEST_PART1, QUEST_PART2, QUEST_PART3, QUEST_PART5, QUEST_PART6, QUEST_PART7,

		QUEST_ORB,

		ITEMID_END
	};
	enum class NPCTAG		{ TRADER, ALCHEMIST, BARD, OLD_MAN, DOG, WIZARD, PAHNTOM, NPC_END}; //상인, 연금술사(포션), 잡NPC, 음유시인, 노인, 개, 마법사(흑막예정)
	...
	enum EFFECTTAG          { EFFECT_BUBBLE, EFFECT_BROKENBOX, EFFECT_DAMAGE, EFFECT_DAMAGESTAR, EFFECT_BLOOD, EFFECT_WAND, EFFECT_EXPLOSION, EFFECT_EXPLOSIONCHILD, EFFECT_PROJECTILETRACE, EFFECT_TRACE, EFFECT_TWINKLE, EFFECT_PASTTRACE, EFFECT_STAR, EFFECT_BONEFIRE, EFFECT_LEAF, EFFECT_LEAVES, EFFECT_FIREFLY, EFFECT_WATERFALL, EFFECT_HEKIREKIISSEN, EFFECT_FIREWORK, EFFECT_END };

	enum PARTICLETAG        { PARTICLE_SQUARE, PARTICLE_FIRECRACKER, PARTICLE_END };
	...
	enum CHANNELID          
	{
		...
		SOUND_BULLET, SOUND_WATER, SOUND_BOSS, SOUND_KINGSPIDER, SOUND_EFFECT2, SOUND_HEKIREKIISSEN = 31, SOUND_MAXCHANNEL
	};
