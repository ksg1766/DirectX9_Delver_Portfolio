...
namespace Engine
{
	...
	enum class OBJECTTAG	{ BACKGROUND, TERRAIN, BLOCK, PLAYER, ITEM, MONSTER, CAMERA, SKYBOX, OBJECT_END };
	enum class COMPONENTTAG	{ BUFFER, TEXTURE, TRANSFORM, COLLIDER, RIGIDBODY, LIGHT, CAMERA, BASICSTAT, MONSTERAI,
								ANIMATOR, PARTICLE, BILLBOARD, COMPONENT_END };
}
