...
namespace Engine
{
	...
	enum UIPOPUPLAYER       { POPUP_MOUSE, POPUP_INVEN, POPUP_EQUIPMENT, POPUP_STAT, POPUP_ITEM, POPUP_MAP, POPUP_SPEECH, POPUP_SHOP, POPUP_LEVELUP, POPUP_ESC, POPUP_BLACK, POPUP_END };
